...
public class Projects extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    ProjectsViewPagerAdapter projectsViewPagerAdapter;
    TextView type;
    ...
    public void fragmentManager() {
        ...
        projectsViewPagerAdapter = new ProjectsViewPagerAdapter(fragmentManager, getLifecycle(), studentNumber, parentId);

        viewPager2.setAdapter(projectsViewPagerAdapter);

...
public class SeatWork extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    SeatWorkViewPagerAdapter seatWorkViewPagerAdapter;
    TextView type;
    ...
    public void fragmentManager() {
        ...
        seatWorkViewPagerAdapter = new SeatWorkViewPagerAdapter(fragmentManager, getLifecycle(), studentNumber, parentId);

        viewPager2.setAdapter(seatWorkViewPagerAdapter);
